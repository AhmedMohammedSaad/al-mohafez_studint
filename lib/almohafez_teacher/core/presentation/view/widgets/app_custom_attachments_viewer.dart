...
enum UrlType { image, memoryImage, youtube, video, voice, file, unknown }

class AppCustomAttachmentsViewer extends StatelessWidget {
  const AppCustomAttachmentsViewer({super.key, required this.multimediaLink});
  ...
  Widget build(BuildContext context) {
    ...
    switch (urlType) {
      case UrlType.image:
        return PicturePreview(image: multimediaLink, isMemory: false);
      case UrlType.memoryImage:
        return PicturePreview(image: multimediaLink, isMemory: true);
      case UrlType.video:
        return VideoPreview(videourl: multimediaLink, isdownloadallowed: false);
      case UrlType.voice:
        return SizedBox(
          height: 500,
          width: 200,
          child: MultiPlayback(isMe: false, audioUrl: multimediaLink),
        );
      case UrlType.file:
        return FilePreview(file: multimediaLink);
          ...
          children: [
            ...
            Positioned(
              ...
              child: MaterialButton(
                ...
                child: Icon(Icons.close, color: AppColors.secondary, size: 25),
              ),
            ),
          ],
        ),
