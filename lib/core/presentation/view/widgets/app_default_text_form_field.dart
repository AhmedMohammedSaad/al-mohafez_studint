...
class AppDefaultTextFormField extends StatefulWidget {
  ...
  @override
  State<AppDefaultTextFormField> createState() => _AppDefaultTextFormFieldState();
}
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle:
                  widget.hintTextStyle ?? AppTextStyle.font14SecondaryW700.copyWith(color: AppColors.mainWhite600),
              ...
              focusedBorder: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color:
                      isFocus ? widget.borderColor ?? AppColors.primaryColor2 : AppColors.grey.withValues(alpha: 0.3),
                  width: 1,
                ),
              ),
...
class PrefixIconData {
  const PrefixIconData({
    ...
    this.size,
    this.text,
  }) : assert(imagePath != null || icon != null || text != null, 'Either imagePath, icon, or text must be provided');
