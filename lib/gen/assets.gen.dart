...
class $AssetsImagesGen {
  ...
  AssetGenImage get placeholder => const AssetGenImage('assets/images/placeholder.webp');
...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/logoName.svg
  SvgGenImage get logo => const SvgGenImage('assets/logo/logoName.svg');
...
class $AssetsSvgsGen {
  ...
  SvgGenImage get welcome => const SvgGenImage('assets/svgs/welcome.svg');

  /// List of all assets
  List<SvgGenImage> get values => [apple, facebook, google, welcome];
}
