...
class _SessionDetailsScreenState extends State<SessionDetailsScreen>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.resumed && _isJoiningSession) {
  ...
  void _joinSession() async {
    ...
    try {
      final uri = Uri.parse(_session!.meetingUrl!);
  ...
  void _showRatingDialog() {
    ...
    showDialog(
      ...
      builder: (context) => SessionRatingDialog(
        ...
        tutorImageUrl: _session!.tutorImageUrl,
        onSubmit: (rating, comment, tags) async {
          ...
          print('📦 Rating model created for tutor: ${_session!.tutorId}');

          final success = await SessionsService.submitSessionRating(
            ratingModel,
          );

          print('✅ Rating submission result: $success');
