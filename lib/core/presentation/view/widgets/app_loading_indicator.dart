...
class _SpinningLinesLoaderState extends State<SpinningLinesLoader> with SingleTickerProviderStateMixin {
...
class _PulseCircleLoaderState extends State<PulseCircleLoader> with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
