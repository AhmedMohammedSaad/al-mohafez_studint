...
class AppColors {
  ...
  // الأزرق البنفسجي الأساسي - لون الهوية الرئيسي (محسن للتطبيق الإسلامي)
  static Color get primaryBlueViolet =>
      AppConst.isDark ? const Color(0xFF4F46E5) : const Color(0xFF4F46E5);

  // التركواز الأساسي - لون الهوية الثانوي (محسن)
  ...
  // الرمادي الداكن - للنصوص الأساسية (محسن للقراءة)
  static Color get primaryDark =>
      AppConst.isDark ? const Color(0xFF111827) : const Color(0xFF111827);

  // النص الأساسي - لون محسن للقراءة
  static Color get textPrimary =>
      AppConst.isDark ? const Color(0xFF111827) : const Color(0xFF111827);

  // النص الثانوي - لون محسن للنصوص الفرعية
  static Color get textSecondary =>
      AppConst.isDark ? const Color(0xFF6B7280) : const Color(0xFF6B7280);

  // الذهبي الفاتح - للإنجازات والمكافآت (محسن)
  static Color get primaryGold =>
      AppConst.isDark ? const Color(0xFFF59E0B) : const Color(0xFFF59E0B);

  // الأخضر للنجاح والإنجازات (محسن)
  static Color get primarySuccess =>
      AppConst.isDark ? const Color(0xFF059669) : const Color(0xFF059669);

  // البرتقالي للتحذيرات (محسن)
  static Color get primaryWarning =>
      AppConst.isDark ? const Color(0xFFF59E0B) : const Color(0xFFF59E0B);

  // الأحمر للأخطاء (محسن)
  static Color get primaryError =>
      AppConst.isDark ? const Color(0xFFDC2626) : const Color(0xFFDC2626);

  // خلفية التطبيق الرئيسية (محسنة)
  ...
  // الرمادي الفاتح للنصوص الثانوية (بديل)
  static Color get textSecondaryAlt =>
      AppConst.isDark ? const Color(0xFF6B7280) : const Color(0xFF6B7280);
  ...
  static Color get green => greenColor;
  static const Color yellowColor = Colors.yellow;
  static Color get yellow => yellowColor;
